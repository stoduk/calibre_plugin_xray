...
#
# Created: Fri May 24 19:42:41 2013
...
class Ui_XRay(object):
    def setupUi(self, XRay):
        ...
        XRay.resize(499, 330)
        self.gridLayout_7 = QtGui.QGridLayout(XRay)
        ...
        self.gridLayout_7.addLayout(self.gridLayout_4, 5, 0, 1, 1)
        self.buttonBox = QtGui.QDialogButtonBox(XRay)
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtGui.QDialogButtonBox.Cancel|QtGui.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName(_fromUtf8("buttonBox"))
        self.gridLayout_7.addWidget(self.buttonBox, 6, 0, 1, 1)
